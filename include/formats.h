...
#define ENSDFSTRBUFSIZE          9540000
...
typedef struct
{
  ...
  SDL_Color textColNormal[UITHEME_ENUM_LENGTH], textColInactive[UITHEME_ENUM_LENGTH]; //colors for text (cannot be floating point as this is not supported by SDL_ttf)
...
typedef struct
{
  ...
  unsigned int textDragInProgress : 2; //values from text_drag_state_enum
