...
#define CHARTVIEW_BUTTON_WIDTH       200 //in unscaled pixels
...
#define CHARTVIEW_MENU_WIDTH         222 //in unscaled pixels
#define CHARTVIEW_MENU_HEIGHT        ((CHARTVIEW_ENUM_LENGTH)*CHARTVIEW_MENU_ITEM_SPACING + 2*UI_PADDING_SIZE) //in unscaled pixels
#define CHARTVIEW_MENU_COLUMNS       3
...
#define SEARCH_MENU_POS_XR           93 //in unscaled pixels
#define SEARCH_MENU_POS_XR_FULLINFO  64 //in unscaled pixels (accounting for the different search menu position in the full level info view)
...
#define NUCLIDE_CONTEXT_MENU_WIDTH   164 //in unscaled pixels
...
//preferences dialog
#define PREFS_DIALOG_NUM_UIELEMENTS                  10
...
#define PREFS_DIALOG_UITHEME_BUTTON_WIDTH            120 //in unscaled pixels
...
#define PREFS_DIALOG_UITHEME_MENU_WIDTH              PREFS_DIALOG_UISCALE_MENU_WIDTH //in unscaled pixels
#define PREFS_DIALOG_UITHEME_MENU_ITEM_SPACING       PREFS_DIALOG_UISCALE_MENU_ITEM_SPACING //in unscaled pixels
...
#define NUCL_INFOBOX_ALLLEVELS_BUTTON_WIDTH     170.0f //in unscaled pixels
...
static const SDL_FColor lighterGrayCol = {0.95f,0.95f,0.95f,1.0f};
