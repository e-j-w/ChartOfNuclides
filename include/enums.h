...
LOCSTR_ICC_GAMMA,LOCSTR_MULTIPOLARITY_GAMMA,LOCSTR_FINALLEVEL,LOCSTR_PROTONSDESC,
LOCSTR_NEUTRONSDESC,LOCSTR_NOTNATURAL,LOCSTR_ALLLEVELS,LOCSTR_BACKTOSUMMARY,
LOCSTR_ALLREACTIONS,LOCSTR_MENUITEM_PREFS,LOCSTR_MENUITEM_SCREENSHOT,
LOCSTR_MENUITEM_ABOUT,LOCSTR_ABOUTSTR_VERSION,LOCSTR_ABOUTSTR_1,LOCSTR_ABOUTSTR_2,
LOCSTR_ABOUTSTR_3,LOCSTR_ABOUTSTR_4,LOCSTR_PREF_SHELLCLOSURE,LOCSTR_PREF_LIFETIME,
LOCSTR_PREF_UIANIM,LOCSTR_PREF_UISCALE,LOCSTR_SMALL,LOCSTR_DEFAULT,LOCSTR_LARGE,
LOCSTR_HUGE,LOCSTR_SL_HOYLE,LOCSTR_SL_NATURALLYOCCURINGISOMER,LOCSTR_SL_CLOCKISOMER,
LOCSTR_SL_SPECTMEDICAL,LOCSTR_SL_E6ISOMER,LOCSTR_SL_PDECAYISOMER,
...
enum level_list_draw_mode_enum{
LLDRAWMODE_ALL, //draw all columns, 
LLDRAWMODE_SKIPICC, //skip ICC
LLDRAWMODE_SKIPICC_MULT, //skip ICC, multipolarity
LLDRAWMODE_SKIPICC_MULT_JF, //skip ICC, multipolarity, final spin
LLDRAWMODE_ENUM_LENGTH
};
enum kbd_mod_enum{
KBD_MOD_NONE,
KBD_MOD_CTRL,
