...
LOCSTR_DECAYMODE,LOCSTR_ENERGY_GAMMA,LOCSTR_INTENSITY_GAMMA,LOCSTR_MULTIPLICITY_GAMMA,
LOCSTR_FINALLEVEL,LOCSTR_ALLLEVELS,LOCSTR_BACKTOSUMMARY,LOCSTR_ENUM_LENGTH
}; //localization srings
enum draw_opt_enum{
DRAWOPT_NONE,
