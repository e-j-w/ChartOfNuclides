...
LOCSTR_MENUITEM_ABOUT,LOCSTR_ENUM_LENGTH
}; //localization srings
enum draw_opt_enum{
DRAWOPT_NONE,
...
UIELEM_MENU_BUTTON,
UIELEM_PRIMARY_MENU, //buttons in primary menu should be defined in the entries directly following this, in top to bottom order
