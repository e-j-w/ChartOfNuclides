...
LOCSTR_GM_STATE,LOCSTR_LEVELINFO_HEADER,LOCSTR_ENERGY_KEV,LOCSTR_JPI,LOCSTR_HALFLIFE,
LOCSTR_DECAYMODE,LOCSTR_ENERGY_GAMMA,LOCSTR_INTENSITY_GAMMA,LOCSTR_MULTIPOLARITY_GAMMA,
LOCSTR_FINALLEVEL,LOCSTR_ALLLEVELS,LOCSTR_BACKTOSUMMARY,LOCSTR_MENUITEM_PREFS,
LOCSTR_MENUITEM_ABOUT,LOCSTR_ABOUTSTR_VERSION,LOCSTR_ABOUTSTR_1,LOCSTR_ABOUTSTR_2,
LOCSTR_PREF_SHELLCLOSURE,LOCSTR_ENUM_LENGTH
}; //localization srings
enum draw_opt_enum{
DRAWOPT_NONE,
...
UIICON_DOWNARROWS,
UIICON_UPARROWS,
UIICON_CHECKBOX_UNCHECKED,
UIICON_CHECKBOX_CHECKED,
UIICON_ENUM_LENGTH
};
