...
LOCSTR_NOTNATURAL,LOCSTR_ALLLEVELS,LOCSTR_BACKTOSUMMARY,LOCSTR_ALLREACTIONS,
LOCSTR_MENUITEM_PREFS,LOCSTR_MENUITEM_ABOUT,
...
REACTIONTYPE_INELASTICSCATTERING_MULTIEJECTILE,
REACTIONTYPE_NUCL_INELASTICSCATTERING,
REACTIONTYPE_NUCL_INELASTICSCATTERING_MULTIEJECTILE,
REACTIONTYPE_COULEX,
REACTIONTYPE_NUCLTRANSFER,
REACTIONTYPE_NUCLTRANSFER_MISCEJECTILE,
REACTIONTYPE_NUCLTRANSFER_MULTIEJECTILE,
REACTIONTYPE_FRAGMENTATION,
REACTIONTYPE_FRAGMENTATION_MULTIEJECTILE,
REACTIONTYPE_FUSEVAP,
REACTIONTYPE_MISCPARTICLE,
REACTIONTYPE_MISCPARTICLE_MULTIEJECTILE,
REACTIONTYPE_MUONICATOM,
REACTIONTYPE_NEUTRONRESONANCES,
REACTIONTYPE_ENUM_LENGTH
};
enum reaction_particle_enum{
REACTIONPARTICLE_PROJECTILE,
REACTIONPARTICLE_EJECTILE,
REACTIONPARTICLE_TARGET,
REACTIONPARTICLE_ENUM_LENGTH
};
enum evap_particle_type_enum{
EVAPTYPE_NONE,
EVAPTYPE_PROTON,
EVAPTYPE_NEUTRON,
EVAPTYPE_ALPHA,
EVAPTYPE_ENUM_LENGTH
};
enum rxnparticle_type_enum{
RXNPARTICLE_NEUTRON,
RXNPARTICLE_PROTON,
RXNPARTICLE_PROTONNEUTRON,
RXNPARTICLE_DEUTERON,
RXNPARTICLE_TWODEUTERON,
RXNPARTICLE_PROTONDEUTERON,
RXNPARTICLE_TRITON,
RXNPARTICLE_PROTON_TRITON,
RXNPARTICLE_3HE,
RXNPARTICLE_PROTON_3HE,
RXNPARTICLE_PROTON_4HE,
RXNPARTICLE_DEUTERON_4HE,
RXNPARTICLE_ALPHA,
RXNPARTICLE_ELECTRON,
RXNPARTICLE_POSITRON,
RXNPARTICLE_GAMMA,
RXNPARTICLE_PI,
RXNPARTICLE_PIPLUS,
RXNPARTICLE_PIMINUS,
RXNPARTICLE_PIZERO,
RXNPARTICLE_PIPLUS_DEUTERON,
RXNPARTICLE_MU,
RXNPARTICLE_MUMINUS,
RXNPARTICLE_KPLUS,
RXNPARTICLE_KMINUS,
RXNPARTICLE_NU,
RXNPARTICLE_NU_ALPHA,
RXNPARTICLE_NU_ALPHANEUTRON,
RXNPARTICLE_NU_ALPHATWONEUTRON,
RXNPARTICLE_NU_PROTON,
RXNPARTICLE_NU_TWOPROTON,
RXNPARTICLE_NU_NEUTRON,
RXNPARTICLE_NU_PROTONNEUTRON,
RXNPARTICLE_NU_PROTONTWONEUTRON,
RXNPARTICLE_NU_TWOPROTONNEUTRON,
RXNPARTICLE_NU_TWONEUTRON,
RXNPARTICLE_NU_THREENEUTRON,
RXNPARTICLE_NU_SIXNEUTRON,
RXNPARTICLE_X, //various particles
RXNPARTICLE_XNEUTRONS_YPROTONS, //variable number of neutrons and protons
RXNPARTICLE_XNEUTRONS, //variable number of neutrons
RXNPARTICLE_11NEUTRONS,
RXNPARTICLE_13NEUTRONS,
RXNPARTICLE_6HE_NEUTRON,
RXNPARTICLE_8HE_NEUTRON,
RXNPARTICLE_9C,
RXNPARTICLE_9C_TWOPROTON,
RXNPARTICLE_11BE,
RXNPARTICLE_12BE,
RXNPARTICLE_16O,
RXNPARTICLE_17O,
RXNPARTICLE_16O_NEUTRON,
RXNPARTICLE_19B_NEUTRON,
RXNPARTICLE_20N,
RXNPARTICLE_23AL_PROTON,
RXNPARTICLE_30CL_PROTON,
RXNPARTICLE_32CL,
RXNPARTICLE_34AL_NEUTRON,
RXNPARTICLE_40SI_ALPHA,
RXNPARTICLE_34SI,
RXNPARTICLE_50AR,
RXNPARTICLE_52CA,
RXNPARTICLE_56NI,
RXNPARTICLE_76ZN,
RXNPARTICLE_ALPHA_7LI,
RXNPARTICLE_ALPHA_7BE,
RXNPARTICLE_HEAVYION,
RXNPARTICLE_FISSION, //where the end result of particle bombardment is fission
RXNPARTICLE_PROTONFISSION, //proton emission followed by fission
RXNPARTICLE_ENUM_LENGTH
};
