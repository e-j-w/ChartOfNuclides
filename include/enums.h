...
LOCSTR_SEARCH_PLACEHOLDER, LOCSTR_SEARCH_PLACEHOLDER_LEVELINFO, LOCSTR_SEARCHRES_NUCLIDE, 
LOCSTR_SEARCHRES_EGAMMA, LOCSTR_SEARCHRES_ELEVEL, LOCSTR_SEARCHRES_ELEVELDIFF, 
LOCSTR_SEARCHRES_GAMMACASCADE, LOCSTR_SEARCHRES_HALFLIFE, LOCSTR_SEARCHRES_LIFETIME, 
LOCSTR_CLICKACTION_GOTOLEVEL, LOCSTR_CLICKACTION_GOTODAUGHTER,
LOCSTR_ENUM_LENGTH
}; //localization srings
enum draw_opt_enum{
DRAWOPT_NONE,
