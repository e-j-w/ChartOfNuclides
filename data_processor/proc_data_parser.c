...
uint8_t parseRxn(reaction *rxn, const char *rxnstring){
	...
	if(tok!=NULL){
		...
		if((Z>=0)&&(N>=0)){
			...
			rxn->targetNucl |= (uint16_t)((254U) << 7U);
		}else{
